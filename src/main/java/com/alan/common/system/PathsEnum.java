...
public enum PathsEnum {
	MY_DB("G:\\Alan\\Documents\\OneDrive\\Documents\\program\\resources\\data_box.db"), TEST(
			"G:\\Alan\\Documents\\OneDrive\\Documents\\program\\resources\\test.db"), LOG_PATH(getLogPath());
